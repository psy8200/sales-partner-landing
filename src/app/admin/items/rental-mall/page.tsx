...
const RentalMallItemsPage = () => {
  ...
  React.useEffect(() => {
    fetch('/api/admin/items/settings?category=RENTAL_MALL')
      .then(r=>r.json())
      .then(d=>{
        if (d?.items) {
  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-gray-200 pb-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">렌탈몰분양신청 설정</h1>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            ...
            <div>
              ...
              <input value={productName} onChange={(e)=>setProductName(e.target.value)} placeholder="예: 렌탈몰 분양 패키지" title="상품명" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
            <div>
              ...
              >
                ...
                <option key="rental-mall-일시납" value="일시납">일시납</option>
                <option key="rental-mall-1년납" value="1년납">1년납</option>
                <option key="rental-mall-2년납" value="2년납">2년납</option>
                <option key="rental-mall-3년납" value="3년납">3년납</option>
                <option key="rental-mall-5년납" value="5년납">5년납</option>
                <option key="rental-mall-7년납" value="7년납">7년납</option>
                <option key="rental-mall-10년납" value="10년납">10년납</option>
                <option key="rental-mall-15년납" value="15년납">15년납</option>
                <option key="rental-mall-20년납" value="20년납">20년납</option>
                <option key="rental-mall-25년납" value="25년납">25년납</option>
                <option key="rental-mall-30년납" value="30년납">30년납</option>
                <option key="rental-mall-전기납" value="전기납">전기납</option>
              </select>
            </div>
            <div>
...
export default RentalMallItemsPage;
