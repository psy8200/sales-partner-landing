...
const FuneralItemsPage = () => {
  ...
  const [pageTitle, setPageTitle] = useState('상조결합상품신청'); // 기본값
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
            <div>
              ...
              <input value={funeralCompany} onChange={(e)=>setFuneralCompany(e.target.value)} placeholder="예: 동양생명" title="상조사" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
            </div>
            <div>
