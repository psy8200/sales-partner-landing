...
const MorePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[color:var(--bg)] text-[color:var(--text)] pb-20 pt-4">
      {/* 헤더 */}
      <header className="bg-gradient-to-r from-purple-50 via-pink-50 to-rose-50 border-b border-slate-200/40">
        <div className="h-20 px-4 flex items-center justify-center pt-2">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              <h2 className="text-lg font-bold text-purple-700 tracking-wider">
                추가 기능
              </h2>
              <span className="text-2xl">⚙️</span>
            </div>
        ...
        <div className="flex flex-col items-center justify-center py-20">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              더 나은 서비스를 위해 다양한 추가 기능을 준비하고 있습니다.<br />
              곧 만나보실 수 있습니다!
            </p>
