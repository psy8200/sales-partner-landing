          ...
          if (data.user?.name && data.user?.phone) {
            try {
              ...
              if (referralsResponse.ok) {
                ...
                console.log('✅ 웹 정확한 추천인 수 조회 성공:', referralsData);
                ...
                try {
                  ...
                  if (levelResponse.ok) {
                    ...
                    console.log('✅ 웹 승급기준 정보 조회 성공:', levelData);
                  ...
                  console.error('웹 승급기준 정보 조회 오류:', error);
                }
              ...
              console.error('웹 추천인 수 조회 오류:', error);
            }
          }
        } else {
    ...
    if (!user) return;
        ...
        const fetchStatsData = async () => {
          try {
            ...
            if (response.ok) {
              const data = await response.json();
              console.log('✅ 웹 통계 데이터 조회 성공:', data);
              console.log('✅ 웹 totalPaidPoints:', data.stats?.totalPaidPoints);
