      ...
      >
        ...
        <div className="px-6 pb-6">
          <button
            ...
            className="w-full bg-gradient-to-r from-red-500 to-rose-600 text-white py-3 px-6 rounded-xl font-semibold text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
          >
            {confirmText}
          </button>
        </div>
